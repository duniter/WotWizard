...
func (o *Object) WriteFlat (w io.Writer) {
	...
	fmt.Fprintf(w, "%s", o.GetFlatString())
} //WriteFlat
...
// BuildJsonFrom builds and returns a Json describing obj; warning: obj must be nil or a pointer to a global exported record variable of its module, and only its exported fields are taken into account
