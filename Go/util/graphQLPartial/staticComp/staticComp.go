...
// The package graphQLPartial is an implementation of the GraphQL query interface

// This package must be imported for its side effects when the GraphQL compiler is stored in "util/graphQLPartial/staticComp" (file "compVar.go", variable "compiler")
